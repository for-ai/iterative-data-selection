...
curl -X POST -H 'Content-type: application/json' --data '{"text":"Experiment KMeansCentroidDeita_0.05 Starting in co-huan1"}' https://hooks.slack.com/services/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
