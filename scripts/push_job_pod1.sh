...
cd /mnt/ceph_rbd/data-selection/output/data_selection_cohere_Llama-2-7b-hf-cohere-lora-KCenterGreedyDeita-0.05-Llama-2-7b-hf_lora/epoch_4

huggingface-cli upload simonycl/llama-2-7b-hf-cohere-KCenterGreedyDeita-0.05-Llama-2-7b-hf-2e-5 . .
