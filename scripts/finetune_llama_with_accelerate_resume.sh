...
accelerate launch \
    ...
    --lora_dropout 0.1 \
    --num_train_epochs 10 \
    --resume_from_checkpoint /home/co-huan1/rds/rds-qakg-2iBGk7DbOVc/jie/data-selection/output/data_selection_Llama-2-7b-hf-sharegpt-lora-KMenasRandomDeita-64-0.05_lora/epoch_4 \
    --do_eval \
...
# nohup bash scripts/finetune_llama_with_accelerate_resume.sh KMenasRandomDeita_64_0.05 > logs/finetune_with_accelerate_Llama-2-7b-hf-sharegpt-KMenasRandomDeita_64_0.05_lora_1.log 2>&1 &