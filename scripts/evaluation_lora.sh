...
MODEL_NAME=Llama-2-7b-hf-sharegpt-KCenterGreedyDeita-005-lora-lr-2e-4-epoch-9

for peft in simonycl/data-selection-Llama-2-7b-sharegpt-KCenterGreedyDeita-0.05-lora-lr-2e-4
do
    PEFT_PATH=$peft
