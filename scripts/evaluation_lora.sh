...
# sleep for 250 minutes
# sleep 13500

for peft in simonycl/llama-2-7b-hf-cohere-KMeansDynamic-0.05-Llama-2-7b-hf-2e-5
do
...
for peft in simonycl/llama-2-7b-hf-cohere-KMenasRandomDeita-0.05-Llama-2-7b-hf-2e-5 simonycl/llama-2-7b-hf-cohere-KCenterGreedyDeita-0.05-Llama-2-7b-hf-2e-5
do
    cd /mnt/data/data-selection/
    PEFT_PATH=$peft
    MODEL_NAME=$(echo $PEFT_PATH | tr '/' '-' | cut -d '-' -f 2-) # output: llama-2-7b-hf-cohere-Random-0.05 or llama-2-7b-hf-cohere-KCenterGreedyDeita-0.05-Llama-2-7b-hf
