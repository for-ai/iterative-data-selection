...
MODEL_NAME=Llama-2-7b-hf-sharegpt-KCenterGreedyDeita-005-lora-lr-5e-5-epoch-4

# for peft in simonycl/data-selection-Llama-2-7b-sharegpt-KCenterGreedyDeita-0.05-lora
# do
#     PEFT_PATH=$peft
